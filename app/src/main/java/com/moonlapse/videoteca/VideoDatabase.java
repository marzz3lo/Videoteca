...
/**
 * Created by marzzelo on 11/7/2017.
 */
...
public class VideoDatabase {
    ...
    private Cursor query(String selection, String[] selectionArgs,
        ...
        Cursor cursor = new PaginatedCursor(builder.query(mDatabaseOpenHelper
    ...
    private static class VideoDatabaseOpenHelper extends SQLiteOpenHelper {
        ...
        private static final String FTS_TABLE_CREATE =
                "CREATE VIRTUAL TABLE " + FTS_VIRTUAL_TABLE +
                        " USING fts3 (" +
                        KEY_NAME + ", " + KEY_DATA_TYPE + "," + KEY_ICON + "," + KEY_PRODUCTION_YEAR + ");";
        ...
        private void loadMovies() throws IOException {
            if (MovieList.list == null) {
                ...
                String json = Utils.loadJSONFromResource(mHelperContext,
                        R.raw.movies);
                Gson gson = new Gson();
